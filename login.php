...
if(isset($_POST['submit']))
{
	...
	if($result_query){
		if(mysqli_num_rows($result_query)){
			...
			header('location:checkyourstatus.php');
		}
		else
		{
			 $error="your email and password is wrong";
		}
	}
	else
	{
...
<body>
	<header>
		...
		<div class="application">
			...
			<input type="submit" name="submit" vlaue="submit" class="submit"><br><br>
			
			<div class="forgot"><a href="codesent.php">forgot password</a></div>
			<br>


            Don't Have an Account?&nbsp<a href="regi.php" >SignUP</a><br>
